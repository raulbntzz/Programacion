...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
                ...
                <tbody>
                    <?php foreach ($usuarios as $usuario): ?>
                        <tr>
                            ...
                            <td>
                                <a id="boton-amarillo" href="editar_tarea.php?id=<?= $usuario['id'] ?>" class="btn btn-sm">Editar</a>
        ...
        <a href="agregar_tarea.php?id=<?= $_GET['id'] ?>" class="btn add-socio-btn">Agregar Nuevo Usuario</a>
    </div>
</body>
</html>
